...
def sample_data(request):
    ...
    data_server_path = settings.MEDIA_ROOT
    play_data_server_path = settings.PLAYDATA_ROOT
    os.makedirs(data_server_path, exist_ok=True)
    os.makedirs(play_data_server_path, exist_ok=True)
    if request.POST:
        ...
        cur_data = pd.read_csv(os.path.join(play_data_server_path, selected_data + ".csv"))
        new_stamped_name = os.path.join(data_server_path, server_data_names_map[selected_data] + cur_user_id)
